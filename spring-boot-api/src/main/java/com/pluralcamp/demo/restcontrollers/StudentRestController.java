...
public class StudentRestController {
	...
	public ResponseEntity<List<Student>> getStudentsByNameAndSurname(
		...
		List<Student> studentList = 
				this.studentService.getStudentsfindByNameAndSurname(name, surname);
		return ResponseEntity.ok(studentList);
	}
	...
	public ResponseEntity<List<Student>> getStudentsByAge(
		...
		List<Student> studentList = this.studentService.getStudentsByAge
				(age);
		return ResponseEntity.ok(studentList);
	}
	...
	//Para hacer un insert en la base de datos
	@CrossOrigin
	...
	public ResponseEntity<Student> updateStudent(
			@RequestBody Student student, @PathVariable("id") int id) 
	...
	public ResponseEntity<String> deleteStudent(@PathVariable int id) {
		...
		return new ResponseEntity<String>("Student has been delete sucsefully",
				HttpStatus.OK);
	}
